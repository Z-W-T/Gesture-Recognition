...
class SSDMobilenet(TorchVisionModel):
    ...
    def __init__(self, num_classes: int):
        ...
        torchvision_model = torchvision.models.detection.ssdlite320_mobilenet_v3_large(weights=SSDLite320_MobileNet_V3_Large_Weights.DEFAULT)
        ...
        # summary(torchvision_model,input_size = (3,320,320))
